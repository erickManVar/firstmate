...
`config/crew-dispatch.json`, `config/crew-harness`, `config/backlog-backend`, and the project-container base in `config/projects-root` are inherited by secondmate homes.
